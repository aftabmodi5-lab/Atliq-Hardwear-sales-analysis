...
## Description
This project contains SQL queries created to analyze business data and answer different analytical questions.  
The purpose of this project is to practice SQL concepts such as SELECT, JOIN, GROUP BY, ORDER BY, etc.
The data for this project is derived from CodeBasics SQL ad-hoc-challenge
